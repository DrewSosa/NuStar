...
#Automatically scale the figure dimensions.
axarray[0].autoscale()

nodes = []
#Contour Plots
#Extract the data from the contour plot data, and append it to the nodes list.
...
#Flux
#Extract the data from the flux data, and append it to the nodes list.
...
#Change directory to another specified observation.
...
#Loop through a list of obervations and make a 1x3 plot of countour, flux, and delchi vs
...
for obs_id in ids:
    ...
    #delta-chi Plot
    #Extract the data from the contour data, and append it to the nodes list.
