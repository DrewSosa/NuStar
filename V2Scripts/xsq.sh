...
chisq=("0500750101/" "0653380501/" "0653380301/")
...
for source in *; do
    ...
    for id in */; do
        ...
        respdata="$(ls | grep ".rmf")"
            ...
            #flux
            rm chisq_tbabscutoffpl_ld.dat
            rm flux.txt
            rm chisq_tbabscutoffpl.xcm
            ...
            echo "save all chisq_tbabscutoffpl.xcm" >> flux.txt
            ...
            echo "plot ldata" >> flux.txt
            echo "mv wdata.dat chisq_tbabscutoffpl_ld.dat" >> flux.txt
            ...
            echo "mv wdata.dat chisq_tbabscutoffpl+zgauss_con_e.dat" >> chisq.xco
        ...
        rm chisq_tbabscutoffpl_delc.dat
        rm delta_chi.txt
        rm chisq_tbabscutoffpl.xcm
        # rm fit_tbabscutoffpl+zgauss_con_e.txt
        # Standard initial XSPEC commands
            ...
            # Save the best-fit model
            echo "save all chisq_tbabscutoffpl.xcm" >> delta_chi.txt
            ...
            echo "plot delchi" >> delta_chi.txt
            echo "mv wdata.dat chisq_tbabscutoffpl_delc.dat" >> delta_chi.txt
